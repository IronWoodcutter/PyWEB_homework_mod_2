...
ADDRESS_BOOK_MENU = {'title': "Address book menu", 'show all': 'Show all contacts in Book',
                     'add': 'Add contact to Book',
                     'find': 'Find person in Book', "show bd": "Show persons with birthday",
                     'edit': 'Edit personal info',
                     'del': 'Delete personal info', 'remove': 'Remove person from Book',
...
class MenuBook(AbstractMenuBook):
    def __init__(self, table: dict):
        self._table = table.copy()
